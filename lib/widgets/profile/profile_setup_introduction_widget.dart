...
class ProfileSetupIntroductionWidget extends StatefulWidget {
  const ProfileSetupIntroductionWidget({Key? key}) : super(key: key);

  @override
  State<ProfileSetupIntroductionWidget> createState() =>
      _ProfileSetupIntroductionWidgetState();
}

class _ProfileSetupIntroductionWidgetState
    extends State<ProfileSetupIntroductionWidget> {
  String tags = '';
